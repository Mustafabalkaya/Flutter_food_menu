  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          LabelDescription(title: 'Boyut', description: item.size),
          LabelDescription(
              title: 'Durum', description: item.crust, isCenter: true),
          LabelDescription(
              title: 'Teslimat', description: '${item.delivery} Dakika'),
        ],
      ),
    );
  }
